...
namespace Sales_and_Inventory_System
{
    public partial class supplier : UserControl
    {
        ...
        public void CheckStatus_OnLoad()
        {
            if (product_grid.Rows.Count != 0)
            {
                if (Internet.CheckInternet() != false)
                {
                    for (int i = 0; i < product_grid.Rows.Count; i++)
                    {
                        string commandstring = @"SELECT item_code FROM tbl_inventory WHERE product_id_fk = ?id AND item_name = ?name AND item_size = ?size AND item_quantity <> 0 ";
                        ...
                        command.Parameters.Add(new MySqlParameter("?id", MySqlDbType.Int16)).Value = product_grid.Rows[i].Cells[0].Value;
                        command1.Parameters.Add(new MySqlParameter("?id", MySqlDbType.Int16)).Value = product_grid.Rows[i].Cells[0].Value;
        ...
        private void insertforeigntovalue()
        {
            ...
            private void updateforeigntovalue()
            {
            if (Internet.CheckInternet() != false)
            {
                ...
                MySqlCommand command1 = new MySqlCommand(Command1, connection);
                command1.Parameters.Add(new MySqlParameter("?id", MySqlDbType.Int32)).Value = Convert.ToInt32(prod_id.Text);
                command1.Parameters.AddWithValue("?value", null);
                command1.Parameters.Add(new MySqlParameter("?name", MySqlDbType.VarChar)).Value = prod_desc.Text;
        ...
        private void updateforeigntonull()
        {
            if (Internet.CheckInternet() != false)
            {
                ...
                command1.Parameters.Add(new MySqlParameter("?id", MySqlDbType.Int32)).Value = Convert.ToInt32(prod_id.Text);
                command1.Parameters.AddWithValue("?value", null);
                command1.Parameters.Add(new MySqlParameter("?name", MySqlDbType.VarChar)).Value = product_grid.Rows[rowclick].Cells[1].Value.ToString();
                command1.Parameters.Add(new MySqlParameter("?size", MySqlDbType.VarChar)).Value = product_grid.Rows[rowclick].Cells[2].Value.ToString();
        ...
        private void update_product()
        {
            if (Internet.CheckInternet() != false)
            {
                ...
                MySqlCommand command = new MySqlCommand(Command, connection);
                double.TryParse(prod_price.Text, out price);
                command.Parameters.Add(new MySqlParameter("?id", MySqlDbType.Int32)).Value = Convert.ToInt32(prod_id.Text);
                command.Parameters.Add(new MySqlParameter("?name", MySqlDbType.VarChar)).Value = prod_desc.Text;
                command.Parameters.Add(new MySqlParameter("?size", MySqlDbType.VarChar)).Value = size.SelectedItem.ToString();
                command.Parameters.Add(new MySqlParameter("?price", MySqlDbType.Double)).Value = price;
                ...
                try
                {
                    ...
                    connection.Close();
                    sales_management_control.instance.getproduct_info();
                    sales_management_control.instance.getproduct_size();
                    product_management_control.instance.Connection();
                    if ((Application.OpenForms["Add_item"] as Add_item) != null)
                    {
                        MessageBox.Show("window already open");
        ...
        private void delete_product()
        {
            ...
            if (Internet.CheckInternet() != false)
            {
                ...
                command.Parameters.Add(new MySqlParameter("?price", MySqlDbType.Double)).Value = prod_price.Text;
                try
                {
                    connection.Open();
                    MySqlDataReader reader = command.ExecuteReader();
        ...
        {
            Console.WriteLine(product_grid.Rows.Count);
        }
    }
}
